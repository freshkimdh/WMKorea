    ...
    <div class="container" id="review_boardByTitle">
	  ...
	  <div class="card shadow-sm">
	  	<div class="list_picture">
			<a href="review_contentView?rBoardNum=${userSearchList.rBoardNum}&area=${userSearchList.rArea}"><img src="/filePath/${userSearchList.storedFileName ne ' '? userSearchList.storedFileName : 'null.jpg'}" class="img-fluid mx-auto d-block rounded"></a>
	    </div>
	    <div class="card-body">
	      <p class="card-text"><strong>${userSearchList.rTitle}</strong><br>${userSearchList.rInShort}</p>

	      <span class="badge  badge-pill badge-danger ">Like</span> ${userSearchList.like_Cnt}
