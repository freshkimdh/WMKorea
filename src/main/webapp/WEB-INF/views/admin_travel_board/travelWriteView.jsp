...
<p>
<div class="container">
<p align="center" class="display-3" id="disf">Travel Infomation</p>
</div>
...
<!-- 		<label for="tWriter"></label> -->
      	<input type="hidden" class="form-control" id="tWriter" placeholder="" name="tWriter" 
	...
	<div class="row">
	  ...
	  <label for="selDistrict">지역 선택:</label>
      <select class="form-control" id="sel1" name="selDistrict">
        <option>서울</option>
        <option>인천</option>
        <option>경기</option>
        <option>강화</option>
	  ...
	  <label for="selType">유형 선택:</label>
      <select class="form-control" id="sel1" name="selType">
        <option>관광지</option>
        <option>행사</option>
        <option>맛집</option>
        <option>기타</option>
	...
	<div class="row">
		...
		<label for="tName">여행지명:</label>
      	<input type="text" class="form-control" id="tName" placeholder="" name="tName">
    
    	</div>
    	
    	<div class="col">
    	<label for="tTitle">제목:</label>
      	<input type="text" class="form-control" id="tTitle" placeholder="" name="tTitle"> <p>
    	</div>
	</div>
	
	<div class="row">
    	<div class="col"> 
		<label for="tOpenTime">개장 시간:</label>
      	<input type="text" class="form-control" id="tName" placeholder="" name="tName">
    	</div>
    	
    	<div class="col">
    	<label for="tAddress">주소:</label>
      	<input type="text" class="form-control" id="tTitle" placeholder="" name="tTitle"> <p>
    	</div>
	</div>
    ...
    <div class="form-group">
      ...
      <textarea class="form-control" rows="10" id="content" name="tContent"></textarea>
    </div>
    
    <div class="form-group">
      <input type="file" class="form-control-file border" name="tFile">
    </div>
...
<!-- 	<a href="boardList" class="btn btn-dark" role="button" onclick="removeCheck()">취소</a></p> -->
	<a href="seoulList" class="btn btn-dark" role="button" onclick="return confirm('목록으로 돌아가겠습니까?');">취소</a></p>
