...
<form name="boardForm" action="modify2" onsubmit="return validateForm(), validateForm2(), validateForm3(), validateForm4()" method="get" required>
	
	<input type="hidden" name="bId" value="${modifyView.bId}">
	<input type="hidden" name="bGroup" value="${modifyView.bGroup}">
	<input type="hidden" name="bStep" value="${modifyView.bStep}">
	<input type="hidden" name="bIndent" value="${modifyView.bIndent}">
	
	<div class="row">
    	<div class="col">
    
		<label for="bName">이름:</label>
      	<input type="text" class="form-control" id="name" placeholder="" name="bName" value="${modifyView.bName}">
    	...
    	<label for="bTitle">제목:</label>
      	<input type="text" class="form-control" id="title" placeholder="" name="bTitle" value="${modifyView.bTitle}"> <p>
		</div>
    ...
    <div class="form-group">
      ...
      <textarea class="form-control" rows="10" id="content" name="bContent">${modifyView.bContent}</textarea>
    </div>
