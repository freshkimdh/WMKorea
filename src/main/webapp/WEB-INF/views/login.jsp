...
<div class="container">
  ...
  <form action="#">
    <div class="form-group">
      ...
      <input type="id" class="form-control" id="email" placeholder="아이디를 입력해주세요" name="email">
    </div>
    <div class="form-group">
      <label for="pwd">비밀번호 (Password):</label>
      <input type="password" class="form-control" id="pwd" placeholder="비밀번호를 입력해주세요" name="pswd">
    </div>
